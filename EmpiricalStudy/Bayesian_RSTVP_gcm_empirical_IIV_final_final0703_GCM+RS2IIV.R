...
jagsModel <- jags.model(file = "rsonly_empirical_IIV_final0703_GCM+RS2IIV.txt", data = jags_data, 
                        n.chains = 2, n.adapt = 4000) 
update(jagsModel, n.iter = 6000) #2000
...
save(resulttable, file="Updatedresulttable_rstvar_gcm_empirical_IIV_final_0703_GCM+RS2IIV.Rdata")
