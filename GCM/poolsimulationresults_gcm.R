...
#load(paste0("/storage/work/yxl823/Dissertation_revision/DataGeneration/RSTVP_gcm_simulateddata_shift",shift,"_N",N,"O",O,"_1.Rdata"))

load(paste0(data_path, "RSTVP_gcm_simulateddata_shift",shift,"_N",N,"O",O,"_1.Rdata"))

truevalue = c(AR,sd_noise,beta00,sd_beta0,beta1,NA)

parameter = c("AR","sd_noise","beta00","sd_beta0","beta1","sd_int")
