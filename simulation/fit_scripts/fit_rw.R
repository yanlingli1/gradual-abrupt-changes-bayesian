...
jagsModel <- jags.model(file = "model_rw.txt", data = jags_data, inits = fixedinits, 
                        n.chains = 2, n.adapt = 4000) 
update(jagsModel, n.iter = 1000)

parameterlist <- c("beta00","sd_beta0","AR","sd_noise","sd_int","int","deviance")
...
save(resulttable, file=paste0("Result_TVP_rw_shift",shift,"_N",N,"O",O,"_",r1,".Rdata"))
