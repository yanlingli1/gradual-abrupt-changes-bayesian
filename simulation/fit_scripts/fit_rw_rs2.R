...
jagsModel <- jags.model(file = "model_rw_rs2.txt", data = jags_data, inits = fixedinits, 
...
save(resulttable, file=paste0("Result_RSTVP_rw_shift",shift,"_N",N,"O",O,"_",r1,".Rdata"))
