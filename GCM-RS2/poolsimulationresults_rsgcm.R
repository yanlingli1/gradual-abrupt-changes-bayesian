...
truevalue = c(beta00,sd_beta0,beta10,sd_beta1,AR0,sd_AR,sd_noise0,sd_sd_noise,
              gamma0[2],sd_gamma[2],#AR,sd_noise,
...
for (i in 1:nrep){
    ...
    temp = resulttable[c(grep("beta00",rownames(resulttable)),
                         ...
                         grep("sd_noise0",rownames(resulttable)),
                         grep("sd_sd_noise",rownames(resulttable)),
