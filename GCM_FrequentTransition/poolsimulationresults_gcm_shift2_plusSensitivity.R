...
data_path = "/storage/work/xjx5093/GOHIAR_RS/DataGeneration_FrequentTransition/"
...
param_index_sd_betaIIV1 <- 10 
sd_betaIIV1_lower_bounds <- poolresult[param_index_sd_betaIIV1, , 3]
sd_betaIIV1_upper_bounds <- poolresult[param_index_sd_betaIIV1, , 4]
sensitivity_sd_betaIIV1 <- power(sd_betaIIV1_lower_bounds, sd_betaIIV1_upper_bounds)
print("===================================================================")
print(paste("GCM Model's Sensitivity (Type I Error for sd_betaIIV1):", round(sensitivity_sd_betaIIV1, 3)))
print("===================================================================")
