...
jagsModel <- jags.model(file = "tvar_gcm.txt", data = jags_data, inits = fixedinits, 
                        n.chains = 2, n.adapt = 4000) 
update(jagsModel, n.iter = 1000)

parameterlist <- c("beta00","sd_beta0","beta10","sd_beta1",#"MU0","sd_MU",
                   "AR0","sd_AR",
                   "betaIIV00","sd_betaIIV0",
                   "betaIIV10","sd_betaIIV1",
                   #"sd_IIV",
                   "deviance")
...
save(resulttable, file=paste0("Result_TVP_gcm_shift",shift,"_N",N,"O",O,"_",r1,".Rdata"))
